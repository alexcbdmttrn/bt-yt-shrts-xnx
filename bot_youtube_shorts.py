...
# ================================================================
TEMAS_VIRALES_SALUD = [
    {"tema": "beneficios_ocultos", "keywords": ["beneficios", "propiedades", "natural", "medicinal"], "keywords_larga": ["beneficios que no conocías", "propiedades medicinales"], "contextos": ["desayuno saludable", "infusión matutina", "remedio casero"], "busquedas": 850000, "competencia": "media", "ctr_potencial": 9.2, "retencion_objetivo": 78, "duracion_optima": 45, "tendencia": "creciente", "estacionalidad": "todo_el_año", "audiencia_objetivo": "25-55", "engagement_rate": 15.3},
    {"tema": "remedio_casero", "keywords": ["remedio casero", "natural", "sin medicamentos", "tradicional"], "keywords_larga": ["remedios caseros efectivos", "tratamiento natural"], "contextos": ["cocina", "botiquín natural", "jardín medicinal"], "busquedas": 920000, "competencia": "alta", "ctr_potencial": 8.8, "retencion_objetivo": 75, "duracion_optima": 50, "tendencia": "estable", "estacionalidad": "todo_el_año", "audiencia_objetivo": "30-60", "engagement_rate": 14.7},
    {"tema": "dato_cientifico", "keywords": ["ciencia", "estudio", "investigación", "comprobado"], "keywords_larga": ["estudios científicos", "evidencia científica"], "contextos": ["laboratorio", "estudio clínico", "investigación universitaria"], "busquedas": 680000, "competencia": "baja", "ctr_potencial": 10.5, "retencion_objetivo": 82, "duracion_optima": 55, "tendencia": "explosiva", "estacionalidad": "todo_el_año", "audiencia_objetivo": "25-50", "engagement_rate": 17.2},
    {"tema": "cura_milagrosa", "keywords": ["cura", "eliminar", "desaparecer", "sanar"], "keywords_larga": ["como eliminar naturalmente", "cura natural"], "contextos": ["testimonio real", "resultado comprobado", "transformación salud"], "busquedas": 1200000, "competencia": "media", "ctr_potencial": 11.3, "retencion_objetivo": 80, "duracion_optima": 48, "tendencia": "explosiva", "estacionalidad": "todo_el_año", "audiencia_objetivo": "35-65", "engagement_rate": 18.5},
    {"tema": "secreto_ancestral", "keywords": ["secreto", "ancestral", "tradicional", "milenario"], "keywords_larga": ["secreto de los abuelos", "sabiduría ancestral"], "contextos": ["medicina tradicional mexicana", "conocimiento ancestral"], "busquedas": 540000, "competencia": "baja", "ctr_potencial": 9.8, "retencion_objetivo": 77, "duracion_optima": 52, "tendencia": "creciente", "estacionalidad": "todo_el_año", "audiencia_objetivo": "30-60", "engagement_rate": 16.1},
    {"tema": "error_comun", "keywords": ["error", "equivocado", "peligro", "cuidado"], "keywords_larga": ["errores al tomar", "precauciones"], "contextos": ["advertencia salud", "precaución natural", "uso correcto"], "busquedas": 720000, "competencia": "baja", "ctr_potencial": 10.8, "retencion_objetivo": 85, "duracion_optima": 45, "tendencia": "creciente", "estacionalidad": "todo_el_año", "audiencia_objetivo": "25-55", "engagement_rate": 19.2},
    {"tema": "comparacion_natural", "keywords": ["vs", "comparación", "mejor que", "alternativa natural"], "keywords_larga": ["natural vs farmacéutico", "alternativa natural efectiva"], "contextos": ["comparación productos", "alternativas naturales"], "busquedas": 650000, "competencia": "media", "ctr_potencial": 9.5, "retencion_objetivo": 76, "duracion_optima": 50, "tendencia": "estable", "estacionalidad": "todo_el_año", "audiencia_objetivo": "28-55", "engagement_rate": 15.8},
]
...
FORMULAS_TITULOS_SALUD = {
    "pregunta_impacto": ["¿Sabías que {ingrediente} puede {beneficio}?", "¿Por qué NADIE te cuenta esto sobre {ingrediente}?", "¿Qué pasa si tomas {ingrediente} todos los días?", "¿Conocías este SECRETO de {ingrediente}?", "¿Es {ingrediente} realmente efectivo? La ciencia responde"],
    "numero_especifico": ["{numero} beneficios de {ingrediente} que ignorabas", "{numero} razones para usar {ingrediente} HOY", "{numero} formas de usar {ingrediente} (la {numero} te sorprenderá)", "TOP {numero} usos medicinales de {ingrediente}"],
    "secreto_revelado": ["El SECRETO de {ingrediente} que las farmacéuticas ocultan", "Lo que NADIE te dice sobre {ingrediente}", "Descubrí algo PROHIBIDO sobre {ingrediente}", "La VERDAD sobre {ingrediente} que ocultan"],
    "advertencia_salud": ["⚠️ NO tomes {ingrediente} sin saber esto", "🚨 ALERTA: Esto pasa si usas {ingrediente}", "PELIGRO: Error común con {ingrediente}", "CUIDADO con {ingrediente} si tienes {condicion}"],
    "resultado_inmediato": ["Así {beneficio} con {ingrediente} en 7 días", "Elimina {problema} naturalmente con {ingrediente}", "Transforma tu salud con {ingrediente}", "Resultados reales con {ingrediente} en {tiempo}"],
    "comparacion_poder": ["{ingrediente} vs Medicamentos: ¿Cuál es mejor?", "Por qué {ingrediente} supera a los fármacos", "{ingrediente}: La alternativa natural que funciona"],
    "testimonio_real": ["Usé {ingrediente} por 30 días y esto pasó", "Mi experiencia con {ingrediente} para {condicion}", "Cómo {ingrediente} cambió mi salud"],
}
...
PSICOLOGIA_COLOR_SALUD = {
    "energia_vitalidad": {"primario": "#FF6B35", "secundario": "#F7C59F", "acento": "#2EC4B6", "contraste_minimo": 4.5},
    "naturaleza_organico": {"primario": "#2D6A4F", "secundario": "#52B788", "acento": "#FFD166", "contraste_minimo": 4.5},
    "confianza_cientifica": {"primario": "#118AB2", "secundario": "#073B4C", "acento": "#FFD166", "contraste_minimo": 4.5},
    "urgencia_alerta": {"primario": "#E63946", "secundario": "#1D3557", "acento": "#F1FAEE", "contraste_minimo": 7.0},
    "bienestar_calma": {"primario": "#74A57F", "secundario": "#B7E4C7", "acento": "#FFD166", "contraste_minimo": 4.5},
}
...
def calcular_puntuacion_viralidad(tema):
    ...
    return {"score": score_total, "factores": factores, "categoria": "Alta" if score_total > 75 else "Media" if score_total > 50 else "Baja"}
...
def generar_cluster_keywords(tema_principal):
    clusters = {
        "beneficios_ocultos": {"primarias": ["beneficios", "propiedades", "natural", "medicinal"], "secundarias": ["salud", "bienestar", "curativo", "terapéutico"], "long_tail": ["beneficios para la salud", "propiedades medicinales comprobadas", "usos terapéuticos"], "relacionadas": ["hierbas medicinales", "remedios naturales", "medicina alternativa"]},
        "remedio_casero": {"primarias": ["remedio casero", "natural", "casero", "tradicional"], "secundarias": ["hogar", "fácil", "económico", "accesible"], "long_tail": ["remedios caseros efectivos", "como hacer remedio natural", "tratamiento en casa"], "relacionadas": ["medicina tradicional", "herbolaria", "plantas medicinales"]},
        "dato_cientifico": {"primarias": ["ciencia", "estudio", "investigación", "comprobado"], "secundarias": ["evidencia", "clínico", "universidad", "publicado"], "long_tail": ["estudios científicos comprobados", "investigación médica reciente", "evidencia científica"], "relacionadas": ["salud basada en evidencia", "medicina científica", "investigación salud"]},
        "cura_milagrosa": {"primarias": ["cura", "eliminar", "sanar", "recuperar"], "secundarias": ["resultado", "efectivo", "transformación", "mejoría"], "long_tail": ["cura natural efectiva", "como eliminar naturalmente", "sanación comprobada"], "relacionadas": ["testimonios reales", "resultados comprobados", "transformación salud"]},
        "secreto_ancestral": {"primarias": ["secreto", "ancestral", "tradicional", "milenario"], "secundarias": ["abuelos", "sabiduría", "antiguo", "conocimiento"], "long_tail": ["secreto de los abuelos", "remedio ancestral mexicano", "sabiduría tradicional"], "relacionadas": ["medicina tradicional mexicana", "conocimiento ancestral", "hierbas milenarias"]},
        "error_comun": {"primarias": ["error", "equivocado", "peligro", "cuidado"], "secundarias": ["advertencia", "precaución", "correcto", "seguro"], "long_tail": ["errores al tomar hierbas", "como usar correctamente", "precauciones naturales"], "relacionadas": ["seguridad natural", "uso correcto", "precauciones salud"]},
        "comparacion_natural": {"primarias": ["vs", "comparación", "mejor que", "alternativa"], "secundarias": ["natural", "fármaco", "opción", "elección"], "long_tail": ["natural vs farmacéutico", "alternativa natural efectiva", "mejor opción salud"], "relacionadas": ["medicina comparada", "opciones naturales", "alternativas saludables"]},
    }
    return clusters.get(tema_principal, {"primarias": ["salud", "natural", "bienestar"], "secundarias": ["hierbas", "plantas", "remedios"], "long_tail": ["beneficios para la salud", "remedios naturales"], "relacionadas": ["herbolaria", "medicina natural"]})
...
def analizar_competencia_youtube_salud(tema):
    analisis = {
        "beneficios_ocultos": {"videos_top_10_avg_views": 320000, "avg_ctr_competencia": 7.2, "avg_retencion": 68, "gap_oportunidad": "Falta contenido en español con evidencia científica", "mejor_horario_publicacion": ["07:00", "12:00", "19:00"], "duracion_optima": "45-55 segundos"},
        "remedio_casero": {"videos_top_10_avg_views": 450000, "avg_ctr_competencia": 8.1, "avg_retencion": 72, "gap_oportunidad": "Alta demanda, poca calidad en producción", "mejor_horario_publicacion": ["08:00", "13:00", "20:00"], "duracion_optima": "50-60 segundos"},
        "dato_cientifico": {"videos_top_10_avg_views": 280000, "avg_ctr_competencia": 9.5, "avg_retencion": 78, "gap_oportunidad": "Poca competencia en español, alta credibilidad", "mejor_horario_publicacion": ["09:00", "14:00", "21:00"], "duracion_optima": "55-65 segundos"},
        "cura_milagrosa": {"videos_top_10_avg_views": 520000, "avg_ctr_competencia": 10.2, "avg_retencion": 75, "gap_oportunidad": "Tendencia explosiva, testimonios reales funcionan", "mejor_horario_publicacion": ["07:30", "12:30", "19:30"], "duracion_optima": "48-58 segundos"},
        "secreto_ancestral": {"videos_top_10_avg_views": 380000, "avg_ctr_competencia": 8.8, "avg_retencion": 74, "gap_oportunidad": "Nicho poco explotado, alta conexión emocional", "mejor_horario_publicacion": ["08:30", "13:30", "20:30"], "duracion_optima": "52-62 segundos"},
        "error_comun": {"videos_top_10_avg_views": 410000, "avg_ctr_competencia": 9.8, "avg_retencion": 82, "gap_oportunidad": "Alto engagement por miedo a errores", "mejor_horario_publicacion": ["07:00", "12:00", "19:00"], "duracion_optima": "45-55 segundos"},
        "comparacion_natural": {"videos_top_10_avg_views": 350000, "avg_ctr_competencia": 8.5, "avg_retencion": 71, "gap_oportunidad": "Decisiones de compra, alta conversión", "mejor_horario_publicacion": ["10:00", "15:00", "20:00"], "duracion_optima": "50-60 segundos"},
    }
    return analisis.get(tema, {"videos_top_10_avg_views": 200000, "avg_ctr_competencia": 6.5, "avg_retencion": 65, "gap_oportunidad": "Oportunidad general en salud natural", "mejor_horario_publicacion": ["08:00", "13:00", "19:00"], "duracion_optima": "45-55 segundos"})
...
def crear_miniatura_elite_salud(img_path, texto, tema_viral, output_path):
    ...
    try:
        ...
        print(f"⚠️ Error creando miniatura élite: {e}")
        return False
...
def cargar_analytics_elite():
    try:
        ...
        return {"videos_publicados": [], "mejores_horarios": {}, "mejores_temas": {}, "ctr_promedio": 0, "retencion_promedio": 0}
...
- SEGMENTO 1 (0-25s): Educación sobre {ingrediente}. Inicia con pregunta impactante o dato sorprendente. 2-3 beneficios científicos concretos. Tono educativo pero entretenido. Usa keywords: {', '.join(tema_viral['keywords'][:2])}
...
{{
    ...
    for intento in range(6):
        try:
            ...
            extras = ["salud natural", "bienestar", "herbolaria", "medicina natural", "remedios caseros", "plantas medicinales", "productos naturales"]
            for ext in extras:
            ...
            hashtag_extra = random.choice(["#SaludNatural", "#Herbolaria", "#RemediosCaseros", "#MedicinaNatural", "#Bienestar", "#VidaSaludable"])
...
def buscar_imagen_pexels_salud(query, intentos=3):
    ...
    headers = {"Authorization": PEXELS_API_KEY}
    params = {"query": query_variada, "orientation": "portrait", "per_page": 10, "page": random.randint(1, 8)}
...
# ================================================================
# 🎬 CREAR VIDEO (🛡️ 100% A PRUEBA DE FALLOS DE MÚSICA)
# ================================================================
def crear_video(guion, imagen_path):
    ...
    if not audio1_path or not audio2_path:
        print("❌ No se pudieron generar los audios.")
        return None
    ...
    try:
        ...
        print(f"❌ Error al cargar los audios generados: {e}")
        return None
    ...
    # 🛡️ MANEJO ROBUSTO DE MÚSICA DE FONDO (Evita bloqueos por archivos corruptos)
    # Filtramos archivos .mp3 que pesen más de 5KB para evitar archivos vacíos o corruptos
    ...
    if musicas:
        for musica_path in musicas:
            try:
                ...
                break # Si funciona una, salimos del bucle
            except Exception as e:
                print(f"⚠️ La música '{musica_path}' está corrupta o no es válida. Saltando...")
                continue
    
    if not musica_aplicada:
        print("⚠️ No se pudo cargar ninguna música válida. El video se publicará solo con la voz.")
